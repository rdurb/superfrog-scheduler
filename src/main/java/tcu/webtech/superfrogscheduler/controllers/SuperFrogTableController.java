...
@Controller
public class SuperFrogTableController {
    ...
    @RequestMapping("/superfrogtable")
    public String superfrogtable(Model model, Authentication authentication) {
    ...
    @PreAuthorize("hasAuthority('SUPERFROG')")
    @PostMapping("/superfrogtable/addSuperFrog")
    ...
    @PreAuthorize("hasAuthority('SUPERFROG')")
    @RequestMapping("/superfrogtable/toggleActiveStatus/{userId}")
    ...
    @PreAuthorize("hasAuthority('SUPERFROG')")
    @PostMapping("/superfrogtable/edit")
    ...
    @GetMapping("/superfrogtable/export")
